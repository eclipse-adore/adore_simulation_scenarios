    ...
    return LaunchDescription([
        ...
        *create_simulated_vehicle_nodes(
        ...
        Node(
            ...
            executable="vision_interface",
            name="vision_interface_node",
            parameters=[
                {"traffic_signals_publishing_topic": "traffic_signals"},
                {"detection_subscribing_topic": "/detection_2d_array"},
                {"world_xy_demo_signal": [
                    606481.6035348948, 5797317.597450202]},
            ]
        )
    ])
